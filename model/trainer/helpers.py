...
def get_dataloader(args):
    ...
    num_episodes = args.episodes_per_epoch * num_device if args.multi_gpu else args.episodes_per_epoch  # 100
    ...
    args.num_class = trainset.num_class  # 64
    train_sampler = CategoriesSampler(trainset.label,
                                      num_episodes,
                                      max(args.way, args.num_classes),
                                      args.shot + args.query)  # 38400, 100, max(5,?), 5+15;
    ...
    val_sampler = CategoriesSampler(valset.label,
                                    ...
                                    args.eval_way, args.eval_shot + args.eval_query)  # ,600, 5,  20
    ...
    test_sampler = CategoriesSampler(testset.label,
                                     200,  # args.num_eval_episodes,
                                     args.eval_way, args.eval_shot + args.eval_query)  # ,  ,5,20
