...
class FEAT(FewShotModel):
    ...
    def _forward(self, instance_embs, support_idx, query_idx):
        ...
        proto = support.mean(dim=1) # Ntask x NK x d  [1,1,5,640] 试试5-way 5-shot [1,5,5,640]-->平均后[1,1,5,640]
        num_batch = proto.shape[0]
        num_proto = proto.shape[1]   #1??5
        ...
        if self.training:
            ...
            if self.args.use_euclidean:
                ...
                aux_task = aux_task.permute([1,0,2]).contiguous().view(num_batch, -1, emb_dim) # (Nbatch,  Nq*Nw, d)   [1,80,640]
